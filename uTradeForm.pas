...
begin
  ...
  case how of
    TR_TAKE_ITEMS: begin
      case what of
        CT_COMMON_ITEM: begin
          ...
          TradeForm.lbl2.Caption := 'Взять простую вещь (' + IntToStr(how_many) + ')';
          Reset_ChkBoxes;
        ...
        CT_UNIQUE_ITEM: begin
          TradeForm.lbl2.Caption := 'Взять уникальную вещь (' + IntToStr(how_many) + ')';
        end;
        CT_SPELL: begin
          TradeForm.lbl2.Caption := 'Взять заклинание (' + IntToStr(how_many) + ')';
        end;
        CT_SKILL: begin
          TradeForm.lbl2.Caption := 'Взять умение (' + IntToStr(how_many) + ')';
        end;
        CT_WEAPON: begin
          TradeForm.lbl2.Caption := 'Взять первое попавшееся оружие';
          Reset_ChkBoxes;
          gAvailable_to_buy := 1;
    ...
    TR_BUY_NOM_PRICE: begin
      case what of
        CT_COMMON_ITEM: begin
          TradeForm.lbl2.Caption := 'Купить простую вещь по номинальной цене (' + IntToStr(how_many) + ')';
          Reset_ChkBoxes;
          gavailable_to_buy := 1;
          for i := 1 to how_many do
          begin
    ...
    TR_BUY_ONE_ABOVE: begin
      case what of
        CT_COMMON_ITEM: begin
          TradeForm.lbl2.Caption := 'Купить простую вещь по цене на 1$ выше номинальной цены (' + IntToStr(how_many) + ')';
          Reset_ChkBoxes;
          gavailable_to_buy := 1;
          for i := 1 to how_many do
          begin
    ...
    TR_BUY_ONE_BELOW: begin
      case what of
        CT_COMMON_ITEM: begin
          TradeForm.lbl2.Caption := 'Купить простую вещь по цене на 1$ ниже номинальной цены (' + IntToStr(how_many) + ')';
          Reset_ChkBoxes;
          gavailable_to_buy := 1;
          for i := 1 to how_many do
          begin
    ...
    TR_BUY_ANY_ONE_ABOVE: begin
      case what of
        CT_COMMON_ITEM: begin
          TradeForm.lbl2.Caption := 'Купить простые вещь по цене на 1$ выше номинальной цены, любые или все';
          Reset_ChkBoxes;
          gavailable_to_buy := 3;
          for i := 1 to how_many do
          begin
    ...
    TR_BUY_ANY_ONE_BELOW: begin
      case what of
        CT_COMMON_ITEM: begin
          TradeForm.lbl2.Caption := 'Купить простые вещь по цене на 1$ ниже номинальной цены, любые или все';
          Reset_ChkBoxes;
          gavailable_to_buy := 3;
          for i := 1 to how_many do
          begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          MainForm.lstLog.Items.Add('Игрок получил карту: ' + GetCommonItemNamebyId(crds[1]));
        end
        else
        begin
          ...
          begin
            ...
            MainForm.lstLog.Items.Add('Игрок купил карту: ' + GetCommonItemNamebyId(crds[1]));
            result := true;
          end
          else
          begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          MainForm.lstLog.Items.Add('Игрок получил карту: ' + GetCommonItemNamebyId(crds[2]));
        end
        else
        begin
          if gCurrentPlayer.Money >= price then
          begin
            gCurrentPlayer.AddItem(Common_Items_Deck, crds[2]);
            gCurrentPlayer.Money := gCurrentPlayer.Money - price;
            MainForm.lstLog.Items.Add('Игрок купил карту: ' + GetCommonItemNamebyId(crds[2]));
            result := true;
          end
          else
          begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          MainForm.lstLog.Items.Add('Игрок получил карту: ' + GetCommonItemNamebyId(crds[3]));
        end
        else
        begin
          if gCurrentPlayer.Money >= price then
          begin
            gCurrentPlayer.AddItem(Common_Items_Deck, crds[3]);
            gCurrentPlayer.Money := gCurrentPlayer.Money - price;
            MainForm.lstLog.Items.Add('Игрок купил карту: ' + GetCommonItemNamebyId(crds[3]));
            result := true;
          end
          else
          begin
