...
const
  ...
  MonsterNames: array [1..MONSTER_MAX, 1..2] of string = (
        ...
        ('233', 'Бъяхи'),
        ('1241', 'Дхоул'),
        ('1252', 'Бродящий меж миров'),
        ('1262', 'Старец'),
        ('273', 'Бъяхи'),
        ('1282', 'Огненный вампир'),
        ('1291', 'Летучий полип'),
        ('1302', 'Бесформенная тварь'),
        ('063', 'Бъяхи'),
        ('063', 'Бъяхи'),
        ('063', 'Бъяхи'),
        ('1343', 'Призрак'),
  ...
  aMonsterMoves: array [1..36, 1..3] of integer = (
        (1000, 2000, 5000),
        (2000, 3000, 1000),
        (3000, 4000, 2000),
        (4000, 6000, 3000),
