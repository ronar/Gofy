unit uInvestigatorSelectorForm;
...
type
  TInvestigatorSelectorForm = class(TForm)
...
var
  InvestigatorSelectorForm: TInvestigatorSelectorForm;
  //inv: TInvestigator;
...
procedure TInvestigatorSelectorForm.Button2Click(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TInvestigatorSelectorForm.Button1Click(Sender: TObject);
var
  i, k: integer;
begin
...
procedure TInvestigatorSelectorForm.cbInvPlayer1Change(Sender: TObject);
var
  i, ip: integer;
  F: TextFile;
  s: string[80];
...
begin
  lb1 := (InvestigatorSelectorForm.FindComponent('lb' + skill + '1') as TLabel);
  lb2 := (InvestigatorSelectorForm.FindComponent('lb' + skill + '2') as TLabel);
  lb3 := (InvestigatorSelectorForm.FindComponent('lb' + skill + '3') as TLabel);
  lb4 := (InvestigatorSelectorForm.FindComponent('lb' + skill + '4') as TLabel);
...
procedure TInvestigatorSelectorForm.btnCommItemClick(Sender: TObject);
var
  i, j: integer;
begin
  ...
  begin
    ...
    CardForm.ShowModal;
    players[1].Investigator.AddItem(StrToInt(CardForm.cbCard.text));
  end;
end;

procedure TInvestigatorSelectorForm.btnSpellClick(Sender: TObject);
var
  i, j: integer;
begin
...
procedure TInvestigatorSelectorForm.btnUniqItemClick(Sender: TObject);
var
  i, j: integer;
begin
...
procedure TInvestigatorSelectorForm.btnSkillClick(Sender: TObject);
var
  i, j: integer;
begin
...
procedure TInvestigatorSelectorForm.btnAdd2ndPlayerClick(Sender: TObject);
begin
  player_count := 2;
...
procedure TInvestigatorSelectorForm.btnAdd3rdPlayerClick(Sender: TObject);
begin
  //cbInvPlayer3.Enabled := False;
  //edtPlayer3.Enabled := False;
end;

procedure TInvestigatorSelectorForm.btnAdd4thPlayerClick(Sender: TObject);
begin
  //cbInvPlayer4.Enabled := False;
  //edtPlayer4.Enabled := False;
end;

procedure TInvestigatorSelectorForm.btnAdd5thPlayerClick(Sender: TObject);
begin
  //cbInvPlayer5.Enabled := False;
  //edtPlayer5.Enabled := False;
end;

procedure TInvestigatorSelectorForm.btnAdd6thPlayerClick(Sender: TObject);
begin
  //cbInvPlayer6.Enabled := False;
  //edtPlayer6.Enabled := False;
end;

procedure TInvestigatorSelectorForm.btnAdd7thPlayerClick(Sender: TObject);
begin
  //cbInvPlayer7.Enabled := False;
  //edtPlayer7.Enabled := False;
end;

procedure TInvestigatorSelectorForm.btnAdd8thPlayerClick(Sender: TObject);
begin
  //cbInvPlayer8.Enabled := False;
  //edtPlayer8.Enabled := False;
end;

procedure TInvestigatorSelectorForm.cbInvPlayer2Change(Sender: TObject);
begin
...
procedure TInvestigatorSelectorForm.cbInvPlayer3Change(Sender: TObject);
begin
...
procedure TInvestigatorSelectorForm.cbInvPlayer4Change(Sender: TObject);
begin
...
procedure TInvestigatorSelectorForm.cbInvPlayer5Change(Sender: TObject);
begin
...
procedure TInvestigatorSelectorForm.cbInvPlayer6Change(Sender: TObject);
begin
...
procedure TInvestigatorSelectorForm.cbInvPlayer7Change(Sender: TObject);
begin
...
procedure TInvestigatorSelectorForm.cbInvPlayer8Change(Sender: TObject);
begin
...
procedure TInvestigatorSelectorForm.FormShow(Sender: TObject);
begin
  player_count := 1;
end;

procedure TInvestigatorSelectorForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  //Application.Terminate;
end;
